...
```{python}
# READ FILE
f = open("/Users/huiting/Desktop/ANLY-501/anly-501-project-HuitingSong-1/501-project-website/codes/01-data-gathering/api-keys.json")
input=json.load(f); 
...
data = "/Users/huiting/Desktop/ANLY-501/anly-501-project-HuitingSong-1/501-project-website/data/raw data/"
...
```{python}
twitterdf.to_csv("/Users/huiting/Desktop/ANLY-501/anly-501-project-HuitingSong-1/501-project-website/data/raw data/twitterpython.csv")
```